...
public:
	...
	static void trainFNNStep(FNN& fnn, const std::vector<double>& input, const std::vector<double>& desiredOutput, double learningFactor, bool getConsoleOutput = false);
...
protected:
	...
	static void adjustFNNValues(FNN& fnn, const std::vector<std::vector<double>>& errors, double learningFactor);
};